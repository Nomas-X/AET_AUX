...
force force OCAP_settings_excludeMarkerFromRecord = "['SystemMarker_','ACE_BFT_','RscAttribute','AET_Trigger_Area_','AET_Trigger_Area_']";
force force OCAP_settings_frameCaptureDelay = 0.5;
