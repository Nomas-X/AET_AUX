...
// ACE Map -> Show cursor coordinates = true or false //
force ace_map_mapShowCursorCoordinates = false;

// ACE Map -> BFT Enabled = true or false //
force ace_map_BFT_Enabled = false;

// ACE Map -> Interval = 0.0 to 30.0 //
force ace_map_BFT_Interval = 1;

// ACE Map -> Show player names = true or false //
...
// ACE Uncategorized -> Draw Laser on Map = 0, 1, 2, 3 [0 = Disabled, 1 = Drones, 2 = Vehicles, 3 = Always] //
force ace_laser_showLaserOnMap = 1;

// ACE Vehicles -> (Remove clan logo from vehicles) Enabled = true or false //
...
// AET Disclaimer -> Disable In Editor Preview = true or false //
force AET_disclaimer_SET_disable_in_editor = true;

// AET Disclaimer -> Disable For Admin = true or false //
...
// MrSanchez' Headlamp -> Lamps rendering distance = 50 to 10000 //
