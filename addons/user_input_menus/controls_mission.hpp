...
class CAU_UserInputMenus_ctrlStaticTitle : CAU_UserInputMenus_ctrlStatic {
    moving = 1;
    colorBackground[] = {"(profileNamespace getVariable ['GUI_BCG_RGB_R',0.77])",
...
class CAU_UserInputMenus_ctrlStaticBackgroundDisableTiles: CAU_UserInputMenus_ctrlStaticPictureTile {
    ...
    w = 8;
    h = 4;
    text = "\a3\3DEN\Data\Displays\Display3DENEditAttributes\backgroundDisable_"
            "ca.paa";
    tileW = "8 / (32 * pixelW)";
    tileH = "4 / (32 * pixelH)";
...
class CAU_UserInputMenus_ctrlButton : CAU_UserInputMenus_ctrlDefaultButton {
    ...
    colorFocused[] = {"(profileNamespace getVariable ['GUI_BCG_RGB_R',0.77])",
                        "(profileNamespace getVariable ['GUI_BCG_RGB_G',0.51])",
                        "(profileNamespace getVariable ['GUI_BCG_RGB_B',0.08])", 1};
    font = "PuristaLight";
    text = "";
...
class CAU_UserInputMenus_ctrlListbox : CAU_UserInputMenus_ctrlDefaultText {
    ...
    maxHistoryDelay = 1;
    canDrag = 0;
    soundSelect[] = {"\A3\ui_f\data\sound\RscListbox\soundSelect", 0.090000004,
                    1};
...
class CAU_UserInputMenus_ctrlToolbox : CAU_UserInputMenus_ctrlDefaultText {
    ...
    colorSelectedBg[] = {"(profileNamespace getVariable ['GUI_BCG_RGB_R',0.77])",
                        "(profileNamespace getVariable ['GUI_BCG_RGB_G',0.51])",
                        "(profileNamespace getVariable ['GUI_BCG_RGB_B',0.08])",
                        1};
    onCanDestroy = "";
...
class CAU_UserInputMenus_ctrlXSliderV : CAU_UserInputMenus_ctrlDefault {
    ...
    class Title {
        idc = -1;
        colorBase[] = {1, 1, 1, 1};
        colorActive[] = {"(profileNamespace getVariable ['GUI_BCG_RGB_R',0.77])",
                        "(profileNamespace getVariable ['GUI_BCG_RGB_G',0.51])",
                        "(profileNamespace getVariable ['GUI_BCG_RGB_B',0.08])",
                        1};
    };
