...
[	
	...
	"EDITBOX",
	["TFAR Compatible Radios List", "The provided array will be used to verify whether a radio is TFAR compatible or not. Must already be included in the previous setting's array."],
	["AET Loadout Handler", "Basic Equipment"],
...
[
	...
	["AET Loadout Handler", "Loadout Handling"],
	"",
	1,
	{},
	false
